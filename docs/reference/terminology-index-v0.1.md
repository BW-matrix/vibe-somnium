...
| `ScenePacket` | packet type | committed scene-level packet for downstream rendering and memory | use for committed scene material | still awaiting full schema definition | `dialogue-window-schema-v0.1.md` |
